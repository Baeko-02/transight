...
export default function Home() {
  ...
  return <main><div className="shell"><CaseHeader active={view} />
    {view === 0 && <>
      <section className="hero hero-clean"><div className="hero-copy"><p className="eyebrow"><span>BEGINNER CASE 01</span> · 온체인 추적 입문</p><h1>온체인 추적<br /><em>실습 기초</em></h1><p className="hero-lead">2026년 8월 17일, 한 Ethereum 주소에서 세 가지 활동이 발견됐습니다. Etherscan의 라벨과 토큰 이동 기록만 확인하면 풀 수 있는 초급 문제입니다.</p><div className="hero-actions"><button className="primary-button" onClick={start}>{solved.length ? "문제 계속 풀기" : "문제 시작"}<span>→</span></button><span className="estimate">예상 소요 10–15분</span></div></div>
      </section>
