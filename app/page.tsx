...
export default function Home() {
  ...
  return <main><div className="shell"><CaseHeader section={section} onBasic={showBasic} onInvestigation={showInvestigation} />
    ...
    {section === "basic" && <section className="basic-page">
      <div className="basic-hero"><div><h1>트랜잭션 맵<br /><em>기초 사용법</em></h1></div><div className="basic-count"><b>{String(basicIndex + 1).padStart(2, "0")}</b><span>/ {String(BASIC_ADDRESSES.length).padStart(2, "0")}</span></div></div>
